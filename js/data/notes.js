/* ============================================================
   CONCEPT NOTES - Deep Research Edition
   Distilled from 31 PYQ PDFs (Pinnacle theory sections),
   Gagan Sir classnotes and SSC syllabus analysis.
   Each topic: { name, color, minutes (est. read time),
   sections: [{ heading, body (array of paragraphs) }] }
   ============================================================ */
window.CONCEPT_NOTES = {
    ...
    'number-system': {
        ...
        sections: [
            ...
            {
                heading: '2. Divisibility — the 4-second tests',
                body: [
            ...
            {
                heading: '3. HCF & LCM — identities that appear every year',
                body: [
            ...
            {
                heading: '4. Factors: count, sum, even, odd',
                body: [
                    'If N = p^a × q^b × r^c, then the number of factors is (a+1)(b+1)(c+1) — e.g. 360 = 2^3·3^2·5 has (4)(3)(2) = 24 factors. The SUM of all factors is (1+p+...+p^a)(1+q+...+q^b)(1+r+...+r^c) — for 120 = 2^3·3·5 that is 15 × 4 × 6 = 360.',
                    'Sum of EVEN factors: drop the 2^0 = 1 term from the 2-power bracket: (2+4+8)(1+3)(1+5) = 14 × 4 × 6 = 336. Equivalently total − odd-sum = 360 − 24 = 336. The examiner ALWAYS offers 360 as a trap option. Sum of ODD factors: use only odd-prime brackets: (1+3)(1+5) = 24.',
                    'Trailing zeros of n! = ⌊n/5⌋ + ⌊n/25⌋ + ⌊n/125⌋ + ... — count ALL extra 5s contributed by 25, 125 etc. 36! gives 7+1 = 8; 100! gives 20+4 = 24 (20 is the trap). Unit digits of powers cycle with period 4: 7^2024 → 2024 mod 4 = 0 → last digit 1.'
                ]
            },
            {
                heading: '5. Remainder toolkit',
                body: [
                    'Big-exponent remainders (5^327 ÷ 8, 7^100 ÷ 4) are solved with cycles: compute a^1, a^2, a^3, a^4 mod m until the sequence repeats, then reduce the exponent modulo the cycle length. Products distribute: (a×b) mod m = [(a mod m)(b mod m)] mod m; sums distribute the same way.',
    ...
    'simplification': {
        ...
        sections: [
            {
                heading: '1. VBODMAS — the order that decides the answer',
                body: [
            ...
            {
                heading: '2. Square roots: shortcuts worth 20 seconds',
                body: [
            ...
            {
                heading: '3. Indices & surds law set',
                body: [
                    'p^m × p^n = p^{m+n}; p^m ÷ p^n = p^{m−n}; (p^m)^n = p^{mn}; (pq)^n = p^n q^n; p^0 = 1; p^{−n} = 1/p^n; p^{1/n} = ⁿ√p. Root laws: ⁿ√a × ⁿ√b = ⁿ√(ab); ⁿ√a ÷ ⁿ√b = ⁿ√(a/b); ᵐ√(ⁿ√a) = ᵐⁿ√a; (ⁿ√a)^m = ⁿ√(a^m).',
                    'The rationalising factor of √a is √a; of ∛a it is a^(2/3) — you need enough of the same root to make the index a multiple. For 5th-root of 3, multiply by (5th root of 3)^4.'
                ]
            },
            {
                heading: '4. Standard expansion shortcuts',
                body: [
    ...
    'algebra': {
        ...
        sections: [
            {
                heading: '1. The identity that rules SSC algebra',
                body: [
            ...
            {
                heading: '3. Equations: roots, discriminants, consistency',
                body: [
            ...
            {
                heading: '4. Ratio rules & inequality shortcuts',
                body: [
    ...
    'ratio-proportion': {
        ...
        sections: [
            {
                heading: '1. The 12 ratio definitions',
                body: [
            ...
            {
                heading: '2. Mixture & alligation — the two master formulas',
                body: [
                    ...
                    'The replace-and-repeat formula: if a container has x litres, you remove y litres and replace with water, repeated n times, pure liquid left = x(1 − y/x)^n. This exact pattern appears in nearly every year\'s paper — learn it as a reflex.',
    ...
    'partnership': {
        ...
        sections: [
            {
                heading: '1. The one formula that solves everything',
                body: [
            ...
            {
                heading: '2. Active partner & salary variants',
                body: [
    ...
    'trigonometry': {
        ...
        sections: [
            {
                heading: '1. Ratios, complements, signs',
                body: [
            ...
            {
                heading: '2. Standard values — memorize to the bone',
                body: [
            ...
            {
                heading: '3. The three mother identities',
                body: [
            ...
            {
                heading: '4. Compound angles & product chains',
                body: [
            ...
            {
                heading: '5. The special result sets',
                body: [
    ...
    'heights-distances': {
        ...
        sections: [
            {
                heading: '1. Definitions that must be automatic',
                body: [
            ...
            {
                heading: '2. The five standard cases with their ratios',
                body: [
    ...
    'geometry': {
        ...
        sections: [
            {
                heading: '1. Lines, angles, transversals',
                body: [
            ...
            {
                heading: '2. Triangles — the 20 results you need',
                body: [
            ...
            {
                heading: '3. Circles — properties with marks',
                body: [
            ...
            {
                heading: '4. Quadrilaterals & polygons',
                body: [
            ...
            {
                heading: '5. Coordinate quick tools',
                body: [
    ...
    'mensuration': {
        ...
        sections: [
            {
                heading: '1. 2D figures — the core table',
                body: [
            ...
            {
                heading: '2. 3D solids — the volume & surface table',
                body: [
    ...
    'mixture-alligation': {
        ...
        sections: [
            ...
            {
                heading: '2. The replacement formula',
                body: [
                    'Pure liquid left after n remove-and-replace operations = x(1 − y/x)^n where x = original volume, y = removed each time. Example: 30 L milk, remove 3 L and add 3 L water, three times → 30(1−3/30)³ = 30(0.9)³ = 21.87 L milk.',
...
window.NOTES_TOPIC_COUNT = Object.keys(window.CONCEPT_NOTES).length;
